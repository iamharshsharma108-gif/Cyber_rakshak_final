...
if nav=="Home":
    ...
    for c,label,value in [(c1,"Data sources",len(all_frames())),(c2,"Records",sum(len(x) for x in all_frames().values())),(c3,"Graph nodes",get_graph("all").number_of_nodes()),(c4,"Graph relationships",get_graph("all").number_of_edges())]:
